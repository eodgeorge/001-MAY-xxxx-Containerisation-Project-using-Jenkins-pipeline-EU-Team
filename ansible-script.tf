...
ENV NEW_RELIC_LICENCE_KEY="eu01xxcf86aa28715cf86eff270da689155bNRAL"
WORKDIR /usr/local/tomcat/webapps
...
---
 - hosts: localhost
   ...
   - name: Download WAR file from Nexus repository
     get_url:
       url: http://admin:admin123@${aws_instance.Nexus-server.public_ip}:8081/repository/sample-repo/petclinic/1.0/spring-petc
       dest: /opt/docker
...
echo "license_key: eu01xxcf86aa28715cf86eff270da689155bNRAL" | sudo tee -a /etc/newrelic-infra.yml
