...
#Install New relic
curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo  NEW_RELIC_API_KEY=NRAK-ZMXGEE4CMW080NOMTQJBA4CJABN NEW_RELIC_ACCOUNT_ID=3930289 NEW_RELIC_REGION=EU /usr/local/bin/newrelic install -y
